...
-- Đặt search path nếu cần (áp dụng cho cả schema public lẫn freshmart nếu có)
DO $$
BEGIN
...
-- 7. ĐƠN HÀNG MẪU (Orders & Order Items) ĐỂ BIỂU ĐỒ & DASHBOARD ĐẦY ĐỦ THỜI GIAN THỰC
-- Tạo đơn hàng xuyên suốt các tháng trong năm 2026 và hôm nay

-- 7.1 Đơn hàng hoàn thành hôm nay (Today's Hourly Orders)
...
-- 8. ĐƠN NHẬP HÀNG (Purchase Orders & PO Items)
